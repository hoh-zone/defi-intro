...
module cdp_stablecoin::cdp {
    ...
    public fun open_position<Collateral>(
        ...
        let max_debt = ((collateral_amount as u128)
            * (price as u128)
            * (system.collateral_ratio_bps as u128)
            / ((1_000_000_000u128) * (BPS_BASE as u128))) as u64;
    ...
    public fun liquidate<Collateral>(
        ...
        let current_ratio_bps = ((position.collateral_amount as u128)
            * (price as u128)
            * (BPS_BASE as u128)
            / ((position.debt_amount as u128) * 1_000_000_000u128)) as u64;
        ...
        let debt_value_collateral = ((position.debt_amount as u128)
            * 1_000_000_000u128
    ...
    public fun health_factor<Collateral>(
        position: &CDPPosition<Collateral>,
        price: u64,
    ): u64 {
